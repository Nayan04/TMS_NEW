            ...
            <div class="box-body">
			 ...
			 //print_r($data);die;
                ...
                <td><?php echo $c_name=$db->get_certification_name_by_id($data['certi_id'])?></td>
                  ...
                  <?php } ?>
                  <td class="no-print"><a href="view_panel.php?enq_id=<?php echo $data['enq_id'];?>" class="btn btn-primary" title="View Enquiry In Detail">View </a> &nbsp;<a class="btn btn-danger" href="edit_enquiry.php?enq_id=<?php echo $data['enq_id']; ?>">Edit</a>
                    </li></td>
                </tr>
                <?php 
				}
