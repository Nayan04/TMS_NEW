...
echo $doi=$obj_db->get_date_with_dash($_REQUEST['d_o_ins']);
echo $doi_to=$obj_db->get_date_with_dash($_REQUEST['doi_to']);

$comtype=$_REQUEST['non_type'];
echo $d_o_noncom=$obj_db->get_date_with_dash($_REQUEST['date_of_noncom']);
$date=date("Y-m-d");
$times=date("h:i:s a");
