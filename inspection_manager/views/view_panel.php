        ...
        function Popup(data)
        {
          ...
          //  mywindow.document.write('<style >td{ border:1px dashed gray; }</style>');
            ...
            mywindow.document.write('</head><body >');
			 mywindow.document.write('<div style="width:100%; min-height:120px; padding:2px;"><div style="float:left;width:25%; min-height:100px;"><img src="../../dist/img/logo.png" /></div><div style="float:right;"><?php echo date('d-m-Y h:i:s a'); ?><br> User Name:<?=$_SESSION['name']; ?></div></div><hr>');
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class=""><a href="inbox_inspection.php"  ><i class="fa fa-table"></i> <span>Back</span></a></li>
